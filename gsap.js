...
let tl = gsap.timeline({
    ...
    .fromTo("#first-red-bubble", { opacity: .6 }, { duration: 2, opacity: 1, scale: 1.2, ease: "elastic", repeat: -1 })
    .to("#first-bubble-group", { duration: 2.1, scale: 1.2, ease: "elastic", repeat: -1 })
